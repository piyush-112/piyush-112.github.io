...
const ROWS = [
  ...
  },
  {
    ...
    items: ["HTML", "CSS", "JavaScript", "React", "Angular", "TypeScript", "Bootstrap", "Tailwind CSS"]
  },
  {
    title: "Backend Technologies",
    items: ["Java Spring Boot", "ASP.NET, Web API", "RESTful APIs"]
  },
  {
    title: "Databases",
  ...
  },
  {
    ...
    items: [".NET Framework", ".NET Core", "Entity Framework", "Visual Studio", "NuGet", "LINQ"]
  },
  {
    title: "Version Control & Tools",
    items: ["Git", "GitHub", "Docker", "Bitbucket", "Azure DevOps", "Postman", "Figma", "Visual Studio Code", "JIRA"]
  },
  {
